...
GROQ_API_KEY = "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"
...
class MCQGenerator:
    """Class for generating MCQ questions using Groq API"""
    
    def __init__(self, groq_api_key: str, model_name: str = "mistral-saba-24b"):
        """
    ...
    def generate_mcqs_for_text(self, text: str, num_questions: int = 5) -> List[Dict]:
        ...
        try:
            ...
            completion = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are an expert in creating educational assessment questions that test comprehension and critical thinking."},
...
class TelegramBot:
    ...
    async def start(self, update, context) -> None:
        ...
        await update.message.reply_html(
            f"Hi! I can generate multiple-choice questions from PDF files.\n\n"
    ...
    async def process_pdf(self, update, context) -> None:
        ...
        try:
            ...
            await context.bot.edit_message_text(
                chat_id=update.effective_chat.id, 
                message_id=processing_msg.message_id,
                text=f"Text extracted from {len(pages_text)} pages. Generating questions..."
            )
            ...
            await context.bot.send_message(
                chat_id=update.effective_chat.id,
                text=f"✅ Processing complete! Generated {total_questions} questions from {len(pages_text)} pages."
            )
...
def main() -> None:
    ...
    mcq_generator = MCQGenerator(groq_api_key=GROQ_API_KEY, model_name="mistral-saba-24b")
